...
export default function EditStockTransferPage() {
  ...
  useEffect(() => {
    ...
    stockTransferService
      ...
      .then((t: any) => {
        setTransferNo(t.transferNo || "");
        setTransferDate(toDateInputValue(t.transferDate));
        setFromGodownId(typeof t.fromGodownId === "string" ? t.fromGodownId : t.fromGodownId?._id || "");
        setToGodownId(typeof t.toGodownId === "string" ? t.toGodownId : t.toGodownId?._id || "");
        setNotes(t.notes || "");
        setLines(
  ...
  const handleSave = async (e?: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await stockTransferService.updateStockTransfer(transferId, {
      ...
      console.error(err);
      toast.error(err.message || "Failed to update stock transfer");
    } finally {
