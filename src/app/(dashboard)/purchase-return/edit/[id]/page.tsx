...
export default function EditPurchaseReturnPage() {
  ...
  const purchaseReturnId = params?.id as string;
  ...
  useEffect(() => {
    ...
    purchaseReturnService
      ...
      .then((r: any) => {
        ...
        setSupplierId(typeof r.supplierId === "string" ? r.supplierId : r.supplierId?._id || "");
  ...
  const handleSave = async (e?: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await purchaseReturnService.updatePurchaseReturn(purchaseReturnId, {
                    ...
                    <div className="flex items-center gap-2 w-72">
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          // See purchase-return/add/page.tsx for why this reset exists.
