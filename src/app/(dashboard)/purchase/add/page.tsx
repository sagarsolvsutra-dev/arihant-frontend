...
export default function AddPurchasePage() {
  ...
  // React's `disabled={saving}` on the Save button isn't synchronous enough to block a
  // genuine rapid double-click (both clicks can fire before the re-render commits) —
  // this ref is checked/set synchronously so a second click is dropped immediately,
