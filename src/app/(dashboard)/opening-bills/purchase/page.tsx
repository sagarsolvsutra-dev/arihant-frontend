  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-gray-900">Opening Pending of Purchase Bill</h1>
          <p className="text-sm text-gray-500 mt-1">Manage opening pending purchase bills</p>
        </div>
        <Button onClick={() => router.push("/opening-bills/purchase/add")} leftIcon={<Plus size={16} />} className="btn-primary">
          Add Bill
        </Button>
      </div>
